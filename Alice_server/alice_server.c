...
int main(int argc, char** argv)
{
	...
	//Send encrypted outputs generated by alice_gate to Bob
	ciph = fopen("ciph.txt", "r");
	
	fscanf(ciph, "%s", buffer);
	strcat(buffer, "\n");
	...
	fclose(ciph);
	printf("Alice has sent encrypted outputs to Bob\n");
